...
+ I argue an asymmetric focus on studying the movement patterns of low-income residents in changing neighborhoods has left open theoretical and empirical gaps for researchers. 
  + We know little about the moves of high income individuals and households. 
...
+ I assemble this panel dataset between 1990-2015 at 4 time points. 
  + The 1990 and 2000 are census long form data that are geographically linked to the 2010 re-draw of census tracts. 
    + This is accomplished using the IPUMS geographic crosswalk files.^[More info here: https://www.nhgis.org/geographic-crosswalks] ^[I am happy to discuss this in more depth too if it is of interest to the team.]
...
+ DID is a quasi-experimental research design borrowed from econometrics, that useses the assumption of "parallel pre-treatement trends" as an identification strategy for a causal effect.
  + This means that we find some panel data where there is a pre and post treatment stage, and compare pre-treatment states of both treatment and control groups. 
    + If they are the same, we can assume that the post-treatment difference^[Here is where the name comes in.] is the effect of the treatment on the outcome. 
